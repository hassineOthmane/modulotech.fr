...
//  LynkSales
//
//  Created by hassine othmane on 5/11/18.
//  Copyright © 2018 arlynk. All rights reserved.
//
...
class JustHUD: UIView {
    ...
    public func setFooterLabel(text: String) {
    ...
    public func setFooterLabelWhenIsDisplayed(text: String) {
