...
// MARK: ProfilViewUI Data Source -
/// ProfilViewUI Data Source
protocol ProfilViewUIDataSource {
    func objectFor(ui: ProfilViewUI) -> Contact
}

class ProfilViewUI: UIView {
    var dataSource: ProfilViewUIDataSource?
    var object : Contact?
    ...
    fileprivate func setupConstraints() {
        ...
        //MARK : vStackView
        constraints += [NSLayoutConstraint.init(item: vStackView, attribute: .top, relatedBy: .equal, toItem: self, attribute: .top, multiplier: 1.0, constant: 167)]  //top
        ...
        //MARK : profil
        constraints += [NSLayoutConstraint.init(item: profil, attribute: .top, relatedBy: .equal, toItem: self, attribute: .top, multiplier: 1.0, constant: 150)] // .top
